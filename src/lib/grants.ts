...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    id: "alchemy",
    org: "Alchemy",
    program: "Everyone Onchain Fund (Account Kit apps)",
    gives: "Up to $25k gas + compute credits for smart-wallet / gasless UX apps",
    needs: "Live site, Account Kit, co-marketing; apply via Typeform",
    status: "apply-now",
    url: "https://www.alchemy.com/everyone-onchain-fund",
    unlocks: "Gasless Light Account sends/swaps for founders — our biggest UX unblocker.",
  },
  {
    id: "alchemy-base-gas",
    org: "Alchemy × Base",
    program: "Base Gas Manager Credits",
    gives: "Gas Manager API credits to sponsor UserOps on Base",
    needs: "Building on Base with Gas Manager / Account Kit",
    status: "apply-now",
    url: "https://www.alchemy.com/base-gas-manager-credits",
    unlocks: "Sponsor treasury send + OKX exchange UserOps without forcing ETH deposits.",
  },
  {
    id: "okx-developers",
    org: "OKX Web3",
    program: "OKX Developer Collective — grants, fee subsidies, DEX API",
    gives: "Grants/bounties, API fee subsidies, early DEX endpoints for builders",
    needs: "Active OKX DEX / Onchain OS integration — apply via Developer Collective",
    status: "apply-now",
    url: "https://linktr.ee/okxdevelopers",
    unlocks: "Preferential DEX routing + builder support for in-app Exchange on Aura Wallet Desk.",
  },
  {
    id: "okx-xlayer",
    org: "OKX / X Layer",
    program: "X Layer Build-X / Super Nova + AI Season hackathon grants",
    gives: "Cash prizes, liquidity/launch grants, ecosystem distribution (seasonal)",
    needs: "Ship AI + onchain product; X Layer tracks prefer X Layer deploy",
    status: "apply-now",
    url: "https://web3.okx.com/xlayer/build-x-series",
    unlocks: "Optional X Layer rail + OKX distribution if we expand beyond Base.",
  },
  {
    id: "solana",
