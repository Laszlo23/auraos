...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    id: "base",
    org: "Base / Coinbase",
    program: "Base ecosystem — Builder Rewards, Base Batches, CDP credits",
    gives: "Free CDP API tier plus cohort-based ecosystem rewards and grants",
    needs: "Ship on Base; cohorts are competitive but need no investor",
    status: "apply-now",
    url: "https://www.base.org/build",
    unlocks:
      "We already settle x402 payments and reward drops on Base — this is our closest ecosystem fit.",
  },
  {
    id: "aws-preseed",
  ...
  },
  {
    id: "alchemy",
    org: "Alchemy",
    program: "Startup / growth credits",
    gives: "No published startup-credit page found; standard tiers apply",
    needs: "Contact sales directly",
    status: "unverified",
