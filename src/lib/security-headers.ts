...
export const PUBLIC_VITE_KEYS = [
  ...
  "VITE_CREATOR_CHAIN_ID",
  "VITE_CREATOR_NETWORK",
  "VITE_ROBINHOOD_RPC_URL",
  "VITE_CREATOR_STABLE_RH",
] as const;

/** Names that must never be prefixed with VITE_. */
export const FORBIDDEN_VITE_NAME =
  /^VITE_(?:.*_)?(?:SECRET|MINTER|ANSWER|SERVICE_ROLE|PASSWORD|PASS|IPN|DEPLOYER|PRIVATE_KEY|ALCHEMY_API_KEY)(?:_|$)/i;
