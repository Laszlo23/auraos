    ...
    blocks: [
      {
        ...
        items: [
          ...
          "Phase 1 — Wien: die ersten 100 Betriebe, die erste Gruppe die mitmacht, der Versuch auf der Straße. OS-Desk läuft schon.",
          "Phase 2 — The Hood: nur die ersten 1.000. Extra-Perks plus Hold-to-earn aus echten Desk-, Katalog- und x402-Gebühren, solange das NFT gehalten wird. Dann der Weg zu 1.000 Betrieben und Geld, das jeden Monat wiederkommt.",
          "Phase 3 — AURA im Alltag: Belohnungen, Betriebe die damit zahlen, Handelbarkeit. Fair Launch; escrowed Hood-USDC kauft das offizielle Paar.",
          "Phase 4–7 — Österreich, DACH, Europa, weiter. Keine zweite Founding-Collection.",
          "Wir zählen: Betriebe die zahlen, monatlicher Umsatz, was ein neuer Betrieb kostet, wer abspringt, geprüfte Mitmacher, Hold-to-earn-Claims, erledigte Aufgaben, wie oft betrogen wird, wie oft AURA wirklich wandert. Ziel sind 1.000 Betriebe die bleiben und zahlen — nicht leere Anmeldungen. Hold-to-earn folgt Nutzung — kein festes APY.",
        ],
      },
    ],
  },
