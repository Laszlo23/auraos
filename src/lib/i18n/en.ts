...
export const en: MessageTree = {
  ...
  paywall: {
    ...
    body: "€49/month by card (includes boost) — or €99 Founding Seat (access) / cash / crypto. Then: Stars & Guests.",
    cta: "Unlock · €49/mo",
  },
  social: {
    title: "Post",
  ...
  landing: {
    ...
    navHood: "The Hood",
    navMint: "Mint",
    hoodCue: "mint → liquidity",
    tryCta: "Try Aura",
    tokenOnlyCta: "Token only →",
    ...
    audienceBuildersTitle: "Launch an NFT collection",
    audienceBuildersBody:
      "Deploy on Robinhood Chain, mint in USDG or ETH, and share your branded /c/slug page.",
    ...
    unlockBody:
      "No invite required. Pay once, wake your AI company, then share one invite if you want — friends still pay $299. Token fair launch is a separate event.",
    unlockPay: "Pay $299",
  ...
  donate: {
    ...
    lead: "Pick an amount. We create a NOWPayments invoice with our API key and IPN — you choose the asset on their hosted page.",
    ...
    note: "Powered by NOWPayments. Same IPN as Local Seat / Founding Seat crypto.",
  },
  changelog: {
