...
export const en: MessageTree = {
  ...
  landing: {
    ...
    unlockTitle2: "$299 · 1000 companies · open now.",
    unlockBody:
      "No invite required. Pay once, wake your AI company, then share one invite if you want — friends still pay $299.",
    unlockPay: "Pay $299",
    unlockPayBody: "One-time founding seat — card online.",
    ...
    unlockCta: "Buy founding seat — $299",
    ...
    claimBody:
      "$299 one-time · hard-capped at 1000. The first 1,000 get The Hood founding circle: extra desk perks from real product fees while you’re in. Most of each seat funds the launch book; a slice keeps the lights on. Later members get the OS — not this pack.",
  ...
  greeter: {
    ...
    nudgeScroll:
      "You scrolled past the story. The short path: claim a $299 seat and Atlas starts work.",
    nudgeExit: "Before you go — founding seats are open at $299. I can walk you there in one step.",
  ...
  access: {
    ...
    priceTag: "$299 one-time · {total} seats · pay online",
    blurb:
      "Pay $299 once — card or digital payment. Wake your AI company. After you're in, you get one simple invite link to share — friends still pay $299; you earn in-app credit.",
    friendCode: "Friend code attached",
    buyLabel: "Buy now",
    buyBlurb: "Sign in → pay $299 → seat unlocks. That's the whole door.",
    buyCta: "Card — $299",
    buyCryptoCta: "Digital payment — $299",
  ...
  tour: {
    ...
    stopClaimBody:
      "Founding seats are open at $299. Pay once, wake the company, then share one invite if you want.",
  },
  desk: {
