              ...
              <div className="mt-5 flex items-center gap-2">
                {live ? (
                  ...
                  <button
                    ...
                    className={
                      (state?.canConnect ?? state?.available)
                        ? "flex flex-1 items-center justify-center gap-2 rounded-2xl bg-primary px-3 py-2.5 text-xs font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-50"
                        : "flex flex-1 items-center justify-center gap-2 rounded-2xl border border-border/50 bg-foreground/[0.04] px-3 py-2.5 text-xs font-semibold text-muted-foreground disabled:opacity-70"
                    }
                  >
                    {pending === s.id ? (
                      <Loader2 className="h-3.5 w-3.5 animate-spin" />
