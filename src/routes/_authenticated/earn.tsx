  ...
  return (
    <div className="pb-24">
      ...
      <PageHeader
        ...
        description="Each seated founder gets one invite — the right for a friend to start Aura OS at $29 / month or $299 / year. You earn in-app AURA (company compute reserve) on paid conversions — not cash, and not part of the token launch."
        actions={
          <button
