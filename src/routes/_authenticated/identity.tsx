...
import { OfficialProfileCard } from "@/components/aura/official-profile";
          ...
          <Panel
            ...
            action={
              <Link
                to="/profile"
                search={{ edit: true }}
                className="rounded-2xl bg-foreground/8 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-muted-foreground transition-colors hover:text-foreground"
              >
                Edit official
              </Link>
            }
